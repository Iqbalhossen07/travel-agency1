...
const BlogHero = () => {
  return (
    <section className="relative bg-gray-900 h-84 flex items-center justify-center overflow-hidden">
      {/* Background Image */}
      <img 
        src="https://plus.unsplash.com/premium_photo-1701202021101-8e1cb3f3ca8d?fm=jpg&q=60&w=3000" 
      ...
      <div className="relative z-10 text-center text-white px-4">
        ...
        <motion.p 
          ...
          className="font-lora text-lg md:text-xl mt-4 max-w-2xl mx-auto text-gray-200"
        >
